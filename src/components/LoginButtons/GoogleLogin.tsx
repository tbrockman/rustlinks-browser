import LoginButton, { LoginButtonElement, ProviderLoginProps } from "./LoginButton"

type GoogleLoginProps = ProviderLoginProps
...
export default function GoogleLogin({ icon, oidc_client, children, ...props }: GoogleLoginProps): LoginButtonElement {

    return <LoginButton {...{ icon: icon ?? <Icon width={24} height={24} />, oidc_client, props }} >{children ?? 'Google'}</LoginButton>
}